 ...
 *
 * - <DataProvider> fetches /api/bootstrap once (site settings + the collections
 ...
 *
 * Replacing the backend (e.g. Firebase) means changing src/lib/api.js only;
 * these hooks stay the same.
 */
