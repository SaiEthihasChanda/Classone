...
export const homeSlides = [
  {
    eyebrow: 'Modular Potentiostat Platform',
    title: 'Nexus',
    description: 'A modular potentiostat platform engineered for electrochemical innovation, prototype validation and custom sensor workflows.',
    cta: 'View Details',
    href: '/product/nexus',
    image: '/img/2025-07-Nexus-300x300.jpg',
  },
  {
    eyebrow: 'Portable Instrument',
    title: 'PalmSens4',
    description: 'USB & battery-powered potentiostat, galvanostat and optional FRA for Electrochemical Impedance Spectroscopy — laboratory-grade performance that travels.',
    cta: 'View Details',
  ...
  },
  {
    eyebrow: 'Portable Instrument',
    title: 'EmStat4S',
    description: 'A compact USB-powered potentiostat, galvanostat and optional FRA for EIS — built for flexible lab and field measurements.',
    cta: 'View Details',
    href: '/product/emstat4s',
    image: '/img/2025-07-2-5-300x300.png',
  },
  {
    eyebrow: 'Wearable Sensing',
    title: 'Sensit Wearable',
    description: 'Wearable electrochemical sensing for compact field, health and point-of-care applications where size and mobility matter.',
    cta: 'View Details',
    href: '/product/sensit-wearable',
    image: '/img/2025-07-3-3-300x300.png',
  },
  {
    eyebrow: 'Research Instrument',
    title: 'EmStat4R',
    description: 'A research-focused instrument for portable electrochemistry and development workflows, with flexible software and measurement accuracy.',
    cta: 'View Details',
